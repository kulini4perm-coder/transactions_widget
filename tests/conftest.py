...
@pytest.fixture  # Фикстура для filter_by_currency
...
@pytest.fixture  # Фикстура filter_by_currency с ожидаемыми данными, отсортированными по "USD"
def transactions_usd() -> list[dict]:
    return [
        {
            "id": 939719570,
            "state": "EXECUTED",
...
@pytest.fixture  # Фикстура filter_by_currency с ожидаемыми данными, отсортированными по "RUB"
def transactions_rub() -> list[dict]:
    return [
        {
            "id": 873106923,
            "state": "EXECUTED",
